...
> Full benchmark script: [`benchmark.py`](./benchmark.py) — run with `python benchmark.py --iters 500000`
...
- `orjson` by [ijl](https://github.com/ijl/orjson)
- Official SDK by [Pocket Worlds](https://github.com/pocketzworld/python-bot-sdk)
